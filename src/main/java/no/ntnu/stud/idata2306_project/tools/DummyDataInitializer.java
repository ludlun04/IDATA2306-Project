...
public class DummyDataInitializer implements ApplicationListener<ApplicationReadyEvent> {
  ...
  public void onApplicationEvent(@NonNull ApplicationReadyEvent event) {
    ...
    if (optionalUser2.isPresent()) {
      ...
      Order order1 = new Order(user.getId(), car1.getId(), new Date(System.currentTimeMillis() - 1000000),
          new Date(System.currentTimeMillis() + 1000000), 500, List.of(gps));
      orderRepository.save(order1);

      Order order2 = new Order(user.getId(), car2.getId(), new Date(System.currentTimeMillis() - 1000000),
      ...
      Order order4 = new Order(10L, car2.getId(), new Date(System.currentTimeMillis() - 1000000),
          new Date(System.currentTimeMillis() + 1000000), 700, List.of(childSeat, gps));
      orderRepository.save(order4);

      Order order5 = new Order(10L, car2.getId(), new Date(System.currentTimeMillis() - 1000000),
          new Date(System.currentTimeMillis() + 1000000), 700, List.of(childSeat, gps));
